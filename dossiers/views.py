...
@login_required
@permission_required('dossiers.create')
...
@login_required
@permission_required('dossiers.update')
...
@login_required
@permission_required('dossiers.delete')
...
@login_required
@permission_required('clients.list')
...
@login_required
@permission_required('clients.detail')
...
@login_required
@permission_required('interventions.add')
